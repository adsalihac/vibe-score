    ...
    <main className="relative min-h-screen overflow-x-hidden px-4 pb-10 pt-14 md:px-10 md:pb-14 md:pt-16">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 md:gap-8">
        <motion.section
          ...
          className="signal-frame relative overflow-hidden p-6 md:p-10"
        >
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <p className="mono text-xs uppercase tracking-[0.22em] text-[#ffb000]">
              $ vibescore --target github --mode investigate
            </p>
          </div>
          <h1 className="terminal-cursor mt-5 max-w-4xl text-4xl leading-tight text-[var(--foreground)] sm:text-5xl md:text-7xl">
            SYSTEM REPORTS FOR LIVE REPOSITORIES
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-[var(--muted)] md:text-lg">
            Feed a GitHub repository URL into the scanner to receive health score, dependency warnings, test confidence, and production-readiness diagnostics.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3 md:flex-row">
              <Button
                ...
                disabled={isSubmitting}
                className="h-14 min-w-56 shadow-[0_0_30px_-8px_rgba(51,255,0,0.65)]"
              >
                  ...
                  {INVESTIGATION_LOGS.map((line, index) => {
                    ...
                    return (
                      <div key={line} className="flex items-center gap-2 text-xs">
                        <span
                          className={`h-2 w-2 rounded-full ${done ? "bg-[#33ff00] shadow-[0_0_12px_rgba(51,255,0,0.7)]" : "bg-zinc-700"}`}
                        />
