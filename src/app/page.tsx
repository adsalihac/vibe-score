    ...
    <main className="relative min-h-screen overflow-x-hidden px-4 pb-8 pt-14 md:px-10 md:pb-10 md:pt-16">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 md:gap-8">
        <motion.section
          ...
          className="signal-frame relative overflow-hidden rounded-lg p-6 md:p-10"
        >
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <p className="mono text-xs text-[var(--accent-secondary)]">
              VibeScore / Repository Health Workbench
            </p>
          </div>
        ...
        {phase === "investigating" ? (
          <motion.section
            ...
            animate={{ opacity: 1, y: 0 }}
            className="signal-frame relative overflow-hidden rounded-lg p-5 md:p-7"
          >
            <div className="flex items-center justify-between gap-3 border-b border-[var(--border)] pb-4">
              <div>
                <p className="mono text-xs text-[var(--accent-primary)]">
                  Live analysis
                </p>
